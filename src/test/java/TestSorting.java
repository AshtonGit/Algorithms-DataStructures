...
public class TestSorting {
    ...
    public void AStar(){
        int[][] graph = new int[][]{
                ...
                {0, 0, 0, 0, 2},
                {0, 0, 0, 0,0}};
        int[] heuristic = new int[]{20,3,4,6,0};
        int[] path = AStar.Astar(graph, heuristic, 0);
        int[] correct = new int[]{0,2,0,2,1};
        for(int i=0; i<5; i++) assert(path[i]==correct[i]);
    }
    ...
    public void dijkstra(){
        ...
        int[][] graph = new int[][]{
                ...
                {0, 0, 0, 0, 2},
                {0, 0, 0, 0,0}};
        int[] path = Djikstra.dijkstra(graph, 0);
        int[] correct = new int[]{0,2,0,1,1};
        for(int i=0; i<5; i++)assert(path[i]==correct[i]);
    }
